        ...
        button.setOnClickListener {
            ...
            if (!usernameResult.first) {
                ...
                when (usernameResult.second) {
                    0 -> {
                        usernameTextInputLayout.error = "Username is too short"
                    }
                    1 -> {
                        usernameTextInputLayout.error = "Username is empty"
                    }
                    2 -> {
                        usernameTextInputLayout.error = "Username is not valid"
                    }
                }
            } else {
            ...
            if (!passwordResult.first) {
                ...
                when (passwordResult.second) {
                    0 -> {
                        passwordTextInputLayout.error = "Password is too short"
                    }
                    1 -> {
                        passwordTextInputLayout.error = "Password is empty"
                    }
                    2 -> {
                        passwordTextInputLayout.error = "Password is not valid"
                    }
                }
